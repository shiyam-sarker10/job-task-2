...
const About = () => {
    return (
      <div className="flex justify-center ">
        <div className="p-8 bg-white rounded-lg my-10 shadow dark:bg-gray-800">
            ...
            <div className="p-4">
              <div className="mb-4 text-center opacity-90">
                <a href="#" className="relative block">
                  <img
                    alt="profil"
                    src="https://i.ibb.co/rv2TbZP/inbound1960365438869454108.jpg"
            ...
            <div className="p-4">
              <div className="mb-4 text-center opacity-90">
                <a href="#" className="relative block">
                  <img
                    alt="profil"
                    src="https://i.ibb.co/W6tJbkb/me4.jpg"
                    className="mx-auto object-cover rounded-full h-40 w-40 "
                  />
                </a>
              </div>
